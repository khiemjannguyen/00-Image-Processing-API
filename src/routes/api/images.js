    ...
    __awaiter(void 0, void 0, void 0, function* () {
        try {
            if (!req.query.filename || !req.query.height || !req.query.width) {
                res.status(400).send(
                    'URL contains invalid filename, height or width params!'
                )
                return
            }
            ...
            const resizedImagePath = (0, createResizedImage_1.default)(
                fileName,
                height,
                width
            )
            ...
            if (resizedImagePath) {
                fs_1.promises
                    .readFile(yield resizedImagePath)
                    .then((thumbData) => {
                    ...
                    .catch(() => {
                        console.error
                        res.status(500).send(
                            'Error occured wihle processing image'
                        )
                    })
